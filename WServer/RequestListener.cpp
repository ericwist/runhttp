...
RequestListener::RequestListener(const char* address, int nPort, RequestProcessorFactory& requestProcessorFactory, bool isUDP)
: SocketListener(address, nPort, isUDP)
